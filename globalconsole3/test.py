...
if __name__ == '__main__':
    ...
    # ghosts.purgeHosts()
    # ghosts.importCsvAsHosts('/home/pl55227/Documents/GlobalConsole/GlobalConsole2/hosts/hostsVM.csv')
    ...
    # ghosts.exportHostsToCsv('/home/pl55227/Documents/GlobalConsole/GlobalConsole2/hosts/hosts3exp.csv')

    #creds
    gcreds = gcreds.GcCreds(gconf, glog)

    # gcreds.purgeCreds()
    # gcreds.importCsvAsCreds('/home/pl55227/Documents/GlobalConsole/GlobalConsole2/creds/credsVM.csv')
    ...
    # gcreds.exportCredsToCsv('/home/pl55227/Documents/GlobalConsole/GlobalConsole2/creds/creds3exp.csv')
    ...
    # gcom.scp(mode="put", source="/home/pl55227/Documents/GlobalConsole/GlobalConsole2/upload/myfile1.txt", dest="/tmp", recursive=False, suffix=True, batch=True)
