...
class TestGcConsole(TestCase):
    ...
    def setUp(self):
        ...
        self.gcreds.importCsvAsCreds('/home/pl55227/Documents/GlobalConsole/GlobalConsole2/creds/credsTEST.csv')
        self.ghosts = ghosts.GcHosts(self.gconf, self.glog)
        self.ghosts.purgeHosts()
        self.ghosts.importCsvAsHosts('/home/pl55227/Documents/GlobalConsole/GlobalConsole2/hosts/hostsTEST.csv')
